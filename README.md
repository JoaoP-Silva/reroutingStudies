...
```
## Other Scripts
* [genCharts.py](https://github.com/JoaoP-Silva/reroutingStudies/blob/main/genGraphics.py): Do bootstrap on data and generates differents charts about the outputs.
