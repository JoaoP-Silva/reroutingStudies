...
def main():
    ...
    parser.add_option("--level", dest="level", type="int", default=2, action="store", help="A level to decide how far from congestion to look for candidates for re-routing [default: %default]", metavar="FILE")
